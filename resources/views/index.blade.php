                ...
                <nav class="navbar navbar-expand-lg fixed-top navbar-light px-4 px-lg-5 py-3 py-lg-0">
                    <a href="index.html" class="navbar-brand p-0">
                        <h1 class="display-6 text-primary m-0">
                            <img src="{{ asset('image/agit-light.png') }}" alt="Logo" class="me-2" style="height: 50px; border-radius: 50px;">
                ...
                <div class="row gy-5 align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-lg-4 wow fadeInRight ms-auto" data-wow-delay="0.2s">
                        <div class="bg-white p-4 w-100 rounded-lg custom-shadow text-center" style="border-radius: 5px;">
                            ...
                            <p class="text-green-900">Here's your QR Code👇</p>
                            <div class="result">
                                @if(isset($qrCode))
                                    {!! $qrCode !!}
                                @endif
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start text-white">
                        <img src="{{ asset('image/agit-dark.png')}}" alt="Logo Agit" style="height: 40px; border-radius: 50px;">
                    </div>                    
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Brigitha</a>, All right reserved.</span>
                    </div>
                </div>
            </div>
        </div>
